...
export const EmployeeForm = ({onedit=false,defaultdata=null}) => {
  ...
  const onSubmit = async (data) => {
    ...
    if(onedit){
      //update employee
      const putresponse = await axios.put(`https://ems-hiur.onrender.com/employees/${defaultdata.id}`, data);
      ...
      const postresponse = await axios.post(`https://ems-hiur.onrender.com/employees`,data);
